...
export default function DonationForm() {
  ...
  return (
    <Card className="w-full border-2 border-green-500 bg-white/90 backdrop-blur-sm">
      <CardHeader>
        <CardTitle className="text-3xl text-green-700">Make Your Green Impact</CardTitle>
        <CardDescription>Choose your contribution (minimum ₹20)</CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit}>
          <div className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="amount" className="text-green-600 text-lg">Donation Amount (₹)</Label>
            ...
            <div className="w-full">
              <Slider
                ...
                onValueChange={(value: number) => setAmount(Math.max(20, value))} // Pass a number directly
                max={1000}
                step={10}
            ...
            <Card className="bg-green-100/80 backdrop-blur-sm">
              <CardContent className="pt-6 text-center">
                ...
                <div className="flex items-center justify-center space-x-2">
                  ...
                  <span className="text-4xl font-bold text-green-700">{trees}</span>
                  <span className="text-2xl font-semibold text-green-600">trees</span>
                </div>
