...
export const SidebarLink = ({
  ...
  return (
    <Link
      href={link.href}
      className={cn(
        "flex items-center justify-start gap-2 group/sidebar py-2  rounded-2xl transition duration-200 ease-in-out",
        "hover:bg-red-500 dark:hover:bg-red-500",// Hover background effect
        "hover:pl-1",
        "w-full", 
        className
      )}
    ...
    >
      ...
      <motion.span
        ...
        className="text-black dark:text-white text-m group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0"
      >
        {link.label}
      </motion.span>
    </Link>
