        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <h2 className="text-xl font-semibold">Total Carbon Sequestered</h2>
              <p className="text-lg text-gray-700 mt-2">12,345 tons</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <h2 className="text-xl font-semibold">Annual Sequestration Rate</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">Carbon Sequestration Trends</h2>
