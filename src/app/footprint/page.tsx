...
export function CarbonFootprintAnalysis() {
  ...
  const divStyle = {
    backgroundImage: 'url(https://normecverifavia.com/media/2024/03/8.4-CO2-graph-with-green-background.jpg)', // Path to your image
    ...
    <div className="min-h-screen w-full overflow-y-auto flex flex-col bg-white text-gray-900 dark:bg-gray-900">
      ...
      <div style={divStyle}>
        ...
        <div className="container mx-auto py-10 px-4 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md space-y-4" style={{ opacity: 0.8 }}>
            <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-4">
              Analyse Footprint
            </h2>
            {/* Coal Type Input */}
            <div className="flex flex-col">
              <Label className="text-gray-700 dark:text-gray-300">Coal Type</Label>
              <select
                value={coalType}
            ...
            <div className="space-y-6">
              {[
                { label: "Yearly Coal Production (Tonnes)", value: production, setter: setProduction },
                { label: "Coal Type Conversion Factor (TJ/kt)", value: conversion, setter: setConversion },
                { label: "CO2 Emissions Factor (CO2/TJ)", value: emission, setter: setEmission },
                { label: "Exclusion Factor", value: exclusion, setter: setExclusion },
          ...
          {/* Right: Output */}
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md flex flex-col justify-center items-center" style={{ opacity: 0.8 }}>
            {showResult ? (
        ...
        <div className="mt-12 ml-5 mr-5 p-6 bg-gradient-to-r from-green-400 to-blue-500 dark:bg-gradient-to-r dark:from-green-700 dark:to-blue-800 rounded-xl shadow-lg space-y-6 transform transition-transform hover:scale-105 duration-300">
          ...
          <ul className="list-disc list-inside text-gray-200 dark:text-gray-300 space-y-3">
            <li>
              <strong className="text-yellow-300">Yearly Coal Production:</strong> Total amount of coal produced in
              a specific year.
            </li>
            <li>
              <strong className="text-yellow-300">Coal Type:</strong> Classification of coal based on its carbon
              content and maturity (e.g., bituminous, anthracite, lignite).
            </li>
            <li>
              <strong className="text-yellow-300">Extraction Process:</strong> Method used to extract coal from the
              Earth (e.g., surface mining, underground mining).
            </li>
            <li>
              <strong className="text-yellow-300">Coal Processing:</strong> Steps involved in transforming raw coal
              into usable forms (e.g., cleaning, crushing, pulverizing), and the energy
              consumed during these processes.
            </li>
            <li>
              <strong className="text-yellow-300">Exclusion Factor:</strong> A factor used to account for coal that
              is not burned, such as coal used for non-energy purposes or lost during
              transportation.
            </li>
            <li>
              <strong className="text-yellow-300">Coal Type Conversion Factor:</strong> A factor used to convert
              the mass of coal into energy units (terajoules, TJ) based on the specific
              type of coal.
            </li>
            <li>
              <strong className="text-yellow-300">Effective CO2 Emissions Factor:</strong> A factor representing
