...
export const metadata: Metadata = {
  ...
  description: 'Thank you for your donation to plant trees and combat global warming',
}
    ...
    <div className="min-h-screen bg-cover bg-center flex flex-col items-center justify-center p-4 relative"
      ...
      <Card className="max-w-3xl bg-white/80 backdrop-blur-md relative z-10 overflow-hidden">
        ...
        <CardHeader className="text-center relative z-10">
          ...
          <CardTitle className="text-5xl font-bold text-green-800 mb-6">Thank You for Cooling Our Planet!</CardTitle>
        </CardHeader>
        <CardContent className="space-y-8 relative z-10">
          <p className="text-gray-800 text-xl text-center">
            Your generous contribution will help us plant trees, combat global warming, and create a healthier environment for future generations.
          </p>
          <Card className="bg-green-100/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-semibold text-green-800">Your Impact</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <div className="space-y-4">
            <Button asChild className="w-full bg-green-600 hover:bg-green-700 text-white text-xl h-14">
