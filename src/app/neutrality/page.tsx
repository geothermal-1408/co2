            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-gray-100 p-6 rounded-lg">
                ...
                <p className="mb-4">
                  ...
                  hydroelectric power to reduce your carbon footprint.
                </p>
                <a
                  href="#"
              ...
              <div className="bg-gray-100 p-6 rounded-lg">
                ...
                <p className="mb-4">
                  Invest in carbon offset projects to counterbalance your
              ...
              <div className="bg-gray-100 p-6 rounded-lg">
                ...
                <p className="mb-4">
                  Adopt sustainable practices in your daily operations to reduce
